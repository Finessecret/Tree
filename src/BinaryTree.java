...
public class BinaryTree<T> implements DefaultBinaryTree<T> {
    ...
    public void solution() {
        ...
        solution((SimpleTreeNode) this.getRoot());
    }
    private void solution(SimpleTreeNode curr) {
        if (curr.getRight() != null) solution((SimpleTreeNode) curr.getRight());
        else  {
            curr.right = ((SimpleTreeNode)getRoot()).left;
            root.left = null;
        }
    }
}
